...
namespace TRulerX
{
    public class InfoManager
    {
        ...
        public int UpperRisk = 1;
        public int LowerRisk = 1;
        public int UpperTimeRisk = 1;
        public int LowerTimeRisk = 1;

        public string CompletePosturePicturePath = "posture_02_02.png";
        #endregion
